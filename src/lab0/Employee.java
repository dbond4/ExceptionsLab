...
public class Employee {
    ...
    public void setDaysVacation(int daysVacation) {
        if (daysVacation < 0 || daysVacation > MAX_VACATION_DAYS){
            throw new IllegalArgumentException("days must fall between 0 and 28");
        }
        this.daysVacation = daysVacation;
    }
    ...
    public void setFirstName(String firstName) {
        if (firstName == null || firstName.length() == ZERO){
            throw new IllegalArgumentException("must use a valid name");
        }
        this.firstName = firstName;
    }
    ...
    public void setHireDate(Date hireDate) {
        if (hireDate == null){
            throw new IllegalArgumentException("must use a valid date");
        }
        this.hireDate = hireDate;
    }
    ...
    public void setSsn(String ssn) {
        if (ssn == null || ssn.length() == ZERO){
            throw new IllegalArgumentException("must use a valid social security number");
        }
        this.ssn = ssn;
    }
